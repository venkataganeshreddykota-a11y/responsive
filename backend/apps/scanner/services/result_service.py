...
_BREAKPOINT_ADVICE = {
    "mobile": {"viewport": "Samsung S24 Ultra - 384x854", "css": "@media (max-width: 384px) { ... }", "tip": "Stack columns, keep CTAs visible, and size touch targets around 44px."},
    "tablet": {"viewport": "Samsung S9 FE - 800x1280", "css": "@media (min-width: 641px) and (max-width: 800px) { ... }", "tip": "Use tablet-specific wrapping, two-column layouts where they fit, and avoid fixed desktop widths."},
    "laptop": {"viewport": "Galaxy Book 5 - 1440x900", "css": "@media (min-width: 1025px) and (max-width: 1440px) { ... }", "tip": "Constrain content width and keep navigation/hero spacing balanced for laptop screens."},
}
