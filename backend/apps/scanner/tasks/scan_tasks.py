...
def _run(report_id: int, url: str):
    from apps.scanner.models import ScanReport
    from apps.scanner.analyzers.html_analyzer import analyze
    from apps.scanner.engines.playwright_engine import run_playwright_scan
    from apps.scanner.processors.result_processor import process as process_results
    from apps.scanner.processors.result_processor import actionable_issues
