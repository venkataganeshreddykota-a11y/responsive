...
from .views import (
    ...
    trigger_scan, scan_status, iframe_proxy, live_device_preview, ai_code_context, ai_fix,
...
urlpatterns = [
    ...
    path("ai/context/",                  ai_code_context,     name="ai-code-context"),
    path("ai/fix/",                      ai_fix,              name="ai-fix"),
    path("live-preview/",                live_device_preview, name="live-device-preview"),
