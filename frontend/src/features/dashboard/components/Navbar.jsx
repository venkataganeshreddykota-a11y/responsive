    ...
    <nav className="sticky top-0 z-50 w-full border-b border-surface-border bg-white/95">
      <div className="flex min-h-[56px] w-full flex-wrap items-center gap-3 px-4 py-2 sm:flex-nowrap sm:px-6">
        ...
        <Link to="/dashboard" className="flex items-center gap-2 no-underline">
          <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-accent-500 shadow-orange-glow"
            style={{ fontFamily: "'SF Pro Display', system-ui, sans-serif", fontWeight: 900, fontSize: "13px", color: "#fff", letterSpacing: "-0.5px" }}>
            RT
          </span>
