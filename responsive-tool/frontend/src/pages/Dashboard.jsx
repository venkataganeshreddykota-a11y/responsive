    ...
    <div className="page">
      ...
      <main className="dashboard-main">
        <div className="dashboard-hero">
          ...
          <Link to="/scanner" className="btn-primary btn-lg">
            🔍 Start a New Scan
          </Link>
        </div>
              ...
              <div key={item.id} className="history-card">
                ...
                <div className="history-reports">
                  {item.reports.length === 0 && (
                    <span className="badge badge-info">No reports yet</span>
                  )}
                  {item.reports.map((r) => (
                    <div key={r.id} className="report-row">
                      ...
                      {r.score !== null && (
                        <span className="report-score">Score: {Math.round(r.score)}</span>
                      )}
                    </div>
                  ))}
                </div>
