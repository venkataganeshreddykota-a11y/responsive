...
from .views import ScanURLViewSet, ScanReportViewSet, trigger_scan, scan_status, save_to_drive
...
urlpatterns = [
    ...
    path("scan/<int:report_id>/drive/",  save_to_drive, name="save-to-drive"),
]
