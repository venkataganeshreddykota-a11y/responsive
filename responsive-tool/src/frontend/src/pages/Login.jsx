...
function StatCard({ label, value, sub, accent }) {
  return (
    <div className="panel flex min-h-[112px] flex-col justify-between p-5">
...
function RecentItem({ item }) {
  ...
  return (
    <div className="flex items-center gap-3 rounded-lg border border-surface-border bg-white/70 px-4 py-3 transition-colors hover:bg-white">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <form onSubmit={handleSubmit} className="flex gap-2 sm:w-80">
          <input
            ...
            className="flex-1 rounded-lg border border-surface-border bg-white px-3 py-2 text-xs text-surface-body placeholder-surface-muted outline-none transition focus:border-accent-400 focus:ring-2 focus:ring-accent-400/20"
          />
          <button
            type="submit"
            className="rounded-lg bg-accent-500 px-4 py-2 text-xs font-semibold text-white shadow-orange-glow transition hover:bg-accent-600 active:scale-95"
          >
            Load
          </button>
        </form>
  ...
  return (
    <div className="flex h-full min-h-screen w-full flex-col bg-surface-bg">
      ...
      <div className="flex flex-1 flex-col overflow-hidden lg:flex-row">
        {/* Sidebar */}
        <aside className="flex w-full shrink-0 flex-col gap-4 border-b border-surface-border p-4 scrollbar-thin lg:w-72 lg:border-b-0 lg:border-r lg:p-5 lg:overflow-y-auto">
          <div className="panel p-5">
            <p className="mb-1 text-xs font-semibold uppercase text-accent-500">
            ...
            <Link
              to="/scanner"
              className="inline-flex items-center gap-2 rounded-lg bg-accent-500 px-4 py-2.5 text-sm font-semibold text-white no-underline shadow-orange-glow transition hover:bg-accent-600 active:scale-95"
            >
          ...
          {!loading && allReports.length > 0 && (
            <div className="panel p-4">
              <p className="section-label mb-3">Verdict Breakdown</p>
        ...
        {/* Main */}
        <main className="flex flex-1 flex-col gap-5 overflow-y-auto p-4 scrollbar-thin sm:p-6">
          ...
          <div className="panel p-5">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                <div key={step} className="flex flex-col gap-2 rounded-lg border border-surface-border bg-white/60 p-4">
                  <div className="flex items-center gap-2">
